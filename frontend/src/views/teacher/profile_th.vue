...
const editForm = ref<UpdateTeacherProfileRequest>({
  intro: '',
  contact_email: '',
  expertise: '',
  office_location: ''
...
const updateProfile = async () => {
  ...
  updating.value = true
  try {
    const result = await updateTeacherProfile(editForm.value)
