...
var profile_1 = require("@/api/student/profile");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = profile;
                return [4 /*yield*/, (0, profile_1.getUserProfile)()
                    // 初始化编辑表单
                ];
            case 2:
                _a.value = _b.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, profile_1.updateUserProfile)(editForm.value)];
            case 2:
                result = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, profile_1.changePassword)(passwordForm.value)];
            case 2:
                result = _a.sent();
...
if (__VLS_ctx.loading) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    ((_b = __VLS_ctx.profile) === null || _b === void 0 ? void 0 : _b.student_id);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "info-item" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    ((_c = __VLS_ctx.profile) === null || _c === void 0 ? void 0 : _c.college);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "info-item" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    ((_d = __VLS_ctx.profile) === null || _d === void 0 ? void 0 : _d.major);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "info-item" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    ((_e = __VLS_ctx.profile) === null || _e === void 0 ? void 0 : _e.grade);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "info-item" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    ((_f = __VLS_ctx.profile) === null || _f === void 0 ? void 0 : _f.enrollment_year);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "info-card" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "card-header" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.h2, __VLS_intrinsicElements.h2)({});
    ...
    if (__VLS_ctx.passwordMode) {
        ...
        if (__VLS_ctx.passwordValidationErrors.length > 0) {
            ...
            for (var _i = 0, _g = __VLS_getVForSourceType((__VLS_ctx.passwordValidationErrors)); _i < _g.length; _i++) {
                var error_1 = _g[_i][0];
