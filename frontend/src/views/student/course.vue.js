...
var course_1 = require("@/api/student/course");
...
var filteredCourses = (0, vue_1.ref)([]);
// 获取课程数据
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, course_1.getStudentCourses)()];
            case 2:
                response = _a.sent();
...
var filterCourses = function () {
    filteredCourses.value = courses.value.filter(function (course) {
        var matchesSearch = course.name.toLowerCase().includes(searchKeyword.value.toLowerCase()) ||
            course.teacher_name.toLowerCase().includes(searchKeyword.value.toLowerCase());
        var matchesStatus = true;
        if (statusFilter.value) {
            var courseStatus = (0, course_1.getCourseStatus)(course);
            matchesStatus = courseStatus === statusFilter.value;
        }
        return matchesSearch && matchesStatus;
    });
};
var enterCourse = function (course) {
    router.push("/student/course/".concat(course.id));
};
...
/** @type {__VLS_StyleScopedClasses['course-status']} */ ;
/** @type {__VLS_StyleScopedClasses['course-status']} */ ;
/** @type {__VLS_StyleScopedClasses['course-status']} */ ;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign({ onInput: (__VLS_ctx.filterCourses) }, { type: "text", value: (__VLS_ctx.searchKeyword), placeholder: "输入课程名称..." }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "filter-group" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
...
if (__VLS_ctx.loading) {
    ...
    var _loop_1 = function (course) {
        ...
        (course.name);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: "course-status" }, { class: (__VLS_ctx.getCourseStatus(course)) }));
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)(__assign({ class: "teacher" }));
        (course.teacher_name);
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        (__VLS_ctx.formatDate(course.start_date));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        (__VLS_ctx.formatDate(course.end_date));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        (course.credit);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        (course.semester);
...
var __VLS_self = (await Promise.resolve().then(function () { return __importStar(require('vue')); })).defineComponent({
    setup: function () {
        return {
            ...
            getCourseStatus: course_1.getCourseStatus,
            getStatusText: course_1.getStatusText,
            formatDate: course_1.formatDate,
            username: username,
