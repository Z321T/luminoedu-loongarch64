...
var document_stu_1 = require("@/api/student/document_stu");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = documents;
                return [4 /*yield*/, (0, document_stu_1.getDocumentList)()];
            case 2:
                _a.value = _b.sent();
                filterDocuments();
                return [3 /*break*/, 5];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    loading.value = true;
                    return [4 /*yield*/, (0, document_stu_1.searchDocuments)(searchKeyword.value.trim())];
                case 2:
                    results = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, document_stu_1.uploadDocument)(selectedFile.value, uploadTitle.value.trim())
                    // 上传成功后重新加载文档列表
                ];
            case 2:
                result = _a.sent();
...
var deleteDocument = function (doc) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, (0, document_stu_1.deleteDocument)(doc.document_id)
                    // 删除成功后重新加载文档列表
                ];
            case 2:
                _a.sent();
        ...
        switch (_a.label) {
            case 0:
                ...
                deletePromises = Array.from(selectedDocuments.value).map(function (id) {
                    return (0, document_stu_1.deleteDocument)(id);
                });
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 6]);
