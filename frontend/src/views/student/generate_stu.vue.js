...
var generate_stu_1 = require("@/api/student/generate_stu");
...
var canGenerate = (0, vue_1.computed)(function () {
    var _a, _b, _c, _d;
    // 检查所有模式下的通用必填项
    if (!((_a = exerciseTitle.value) === null || _a === void 0 ? void 0 : _a.trim()) || !((_b = customContent.value) === null || _b === void 0 ? void 0 : _b.trim())) {
        return false;
    }
    if (!((_c = selectedTypes.value) === null || _c === void 0 ? void 0 : _c.length)) {
        return false;
    }
...
var renderedPreview = (0, vue_1.computed)(function () {
    if (previewContent.value) {
        return (0, marked_1.marked)(previewContent.value);
    }
    return '';
});
// 工具函数
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = documents;
                return [4 /*yield*/, (0, generate_stu_1.getVectorizedDocuments)()]; // 使用正确的API
            case 1:
                _a.value = _b.sent(); // 使用正确的API
                console.log('向量化文档列表加载成功，数量:', documents.value.length);
                console.log('文档详情:', documents.value.map(function (doc) { return ({
                    id: doc.document_id,
                    title: doc.title,
            ...
            case 2:
                err_1 = _b.sent();
                console.error('向量化文档列表加载失败:', err_1);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = exercises;
                return [4 /*yield*/, (0, generate_stu_1.getExerciseList)()];
            case 2:
                _a.value = _b.sent();
                filterExercises();
                return [3 /*break*/, 5];
...
var filterExercises = function () {
    if (titleFilter.value.trim()) {
        filteredExercises.value = exercises.value.filter(function (exercise) {
            return getExerciseTitle(exercise.filename).toLowerCase().includes(titleFilter.value.toLowerCase());
        });
    }
    else {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, generate_stu_1.generateExercise)(request)];
            case 2:
                result = _a.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, 4, 5]);
                _a = previewContent;
                return [4 /*yield*/, (0, generate_stu_1.getFileContent)(exercise.filename)];
            case 2:
                _a.value = _b.sent();
                return [3 /*break*/, 5];
            case 3:
                err_4 = _b.sent();
                console.error('预览失败:', err_4);
...
var downloadExercise = function (exercise) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, generate_stu_1.downloadFile)(exercise.filename)];
            case 1:
                blob = _a.sent();
...
var deleteExercise = function (exercise) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!confirm("\u786E\u5B9A\u8981\u5220\u9664\u4E60\u9898 \"".concat(getExerciseTitle(exercise.filename), "\" \u5417\uFF1F\u5220\u9664\u540E\u65E0\u6CD5\u6062\u590D\u3002")))
                    return [2 /*return*/];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, (0, generate_stu_1.deleteExerciseFile)(exercise.filename)];
            case 2:
                _a.sent();
                alert('删除成功');
                return [4 /*yield*/, loadExerciseList()];
